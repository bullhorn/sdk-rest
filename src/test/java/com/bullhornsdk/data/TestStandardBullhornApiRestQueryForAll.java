...
public class TestStandardBullhornApiRestQueryForAll extends BaseTest {
    ...
    @Test
    public void testQueryClientCorporationAppointment() {

        ListWrapper<ClientCorporationAppointment> wrapper = bullhornData.queryForAllRecords(ClientCorporationAppointment.class, where, null, queryParams);

        runAssertions("ListWrapper<ClientCorporationAppointment>", wrapper);
