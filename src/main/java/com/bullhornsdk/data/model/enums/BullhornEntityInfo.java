...
import com.bullhornsdk.data.model.entity.core.standard.ClientCorporation1;
import com.bullhornsdk.data.model.entity.core.standard.ClientCorporation2;
import com.bullhornsdk.data.model.entity.core.standard.ClientCorporation3;
...
import com.bullhornsdk.data.model.entity.core.standard.HousingComplexUtilityAccount;
...
import com.bullhornsdk.data.model.response.list.BatchGroupListWrapper;
import com.bullhornsdk.data.model.response.list.BillMasterListWrapper;
import com.bullhornsdk.data.model.response.list.BillMasterTransactionListWrapper;
import com.bullhornsdk.data.model.response.list.BillableChargeFileAttachmentListWrapper;
import com.bullhornsdk.data.model.response.list.BillableChargeListWrapper;
import com.bullhornsdk.data.model.response.list.BillingProfileListWrapper;
import com.bullhornsdk.data.model.response.list.BillingSyncBatchListWrapper;
...
import com.bullhornsdk.data.model.response.list.CandidateCertificationRequirementListWrapper;
import com.bullhornsdk.data.model.response.list.CandidateEducationListWrapper;
import com.bullhornsdk.data.model.response.list.CandidateFileAttachmentListWrapper;
...
import com.bullhornsdk.data.model.response.list.CanvasReportListWrapper;
import com.bullhornsdk.data.model.response.list.CategoryListWrapper;
import com.bullhornsdk.data.model.response.list.CertificationFileAttachmentListWrapper;
import com.bullhornsdk.data.model.response.list.CertificationGroupListWrapper;
import com.bullhornsdk.data.model.response.list.CertificationListWrapper;
import com.bullhornsdk.data.model.response.list.CertificationRequirementListWrapper;
import com.bullhornsdk.data.model.response.list.CertificationRequirementStatusLookupListWrapper;
import com.bullhornsdk.data.model.response.list.ClientContact1ListWrapper;
import com.bullhornsdk.data.model.response.list.ClientContact2ListWrapper;
import com.bullhornsdk.data.model.response.list.ClientContact3ListWrapper;
import com.bullhornsdk.data.model.response.list.ClientContact4ListWrapper;
import com.bullhornsdk.data.model.response.list.ClientContact5ListWrapper;
import com.bullhornsdk.data.model.response.list.ClientContactFileAttachmentListWrapper;
import com.bullhornsdk.data.model.response.list.ClientContactListWrapper;
import com.bullhornsdk.data.model.response.list.ClientCorporation1ListWrapper;
import com.bullhornsdk.data.model.response.list.ClientCorporation2ListWrapper;
import com.bullhornsdk.data.model.response.list.ClientCorporation3ListWrapper;
import com.bullhornsdk.data.model.response.list.ClientCorporation4ListWrapper;
import com.bullhornsdk.data.model.response.list.ClientCorporation5ListWrapper;
import com.bullhornsdk.data.model.response.list.ClientCorporationCertificationListWrapper;
import com.bullhornsdk.data.model.response.list.ClientCorporationFileAttachmentListWrapper;
...
import com.bullhornsdk.data.model.response.list.CurrencyUnitListWrapper;
import com.bullhornsdk.data.model.response.list.DepartmentListWrapper;
import com.bullhornsdk.data.model.response.list.DiscountListWrapper;
import com.bullhornsdk.data.model.response.list.DistributionListListWrapper;
import com.bullhornsdk.data.model.response.list.EarnCodeListWrapper;
import com.bullhornsdk.data.model.response.list.FileEntityListWrapper;
import com.bullhornsdk.data.model.response.list.GeneralLedgerAccountListWrapper;
import com.bullhornsdk.data.model.response.list.GeneralLedgerSegment1ListWrapper;
import com.bullhornsdk.data.model.response.list.GeneralLedgerSegment2ListWrapper;
import com.bullhornsdk.data.model.response.list.GeneralLedgerSegment3ListWrapper;
import com.bullhornsdk.data.model.response.list.GeneralLedgerSegment4ListWrapper;
import com.bullhornsdk.data.model.response.list.GeneralLedgerSegment5ListWrapper;
import com.bullhornsdk.data.model.response.list.GeneralLedgerSegmentListWrapper;
import com.bullhornsdk.data.model.response.list.GeneralLedgerSegmentTypeListWrapper;
import com.bullhornsdk.data.model.response.list.GeneralLedgerServiceCodeListWrapper;
import com.bullhornsdk.data.model.response.list.HousingComplexFurnitureDeliveryListWrapper;
import com.bullhornsdk.data.model.response.list.HousingComplexListWrapper;
import com.bullhornsdk.data.model.response.list.HousingComplexUnitListWrapper;
import com.bullhornsdk.data.model.response.list.HousingComplexUtilityAccountListWrapper;
import com.bullhornsdk.data.model.response.list.InvoiceStatementBatchListWrapper;
import com.bullhornsdk.data.model.response.list.InvoiceStatementDiscountListWrapper;
import com.bullhornsdk.data.model.response.list.InvoiceStatementExportBatchListWrapper;
import com.bullhornsdk.data.model.response.list.InvoiceStatementExportListWrapper;
import com.bullhornsdk.data.model.response.list.InvoiceStatementLineItemListWrapper;
import com.bullhornsdk.data.model.response.list.InvoiceStatementListWrapper;
import com.bullhornsdk.data.model.response.list.InvoiceStatementMessageTemplateListWrapper;
import com.bullhornsdk.data.model.response.list.InvoiceStatementSurchargeListWrapper;
import com.bullhornsdk.data.model.response.list.InvoiceStatementTaxListWrapper;
import com.bullhornsdk.data.model.response.list.InvoiceStatementTemplateListWrapper;
import com.bullhornsdk.data.model.response.list.InvoiceTermListWrapper;
import com.bullhornsdk.data.model.response.list.JobBoardPostListWrapper;
import com.bullhornsdk.data.model.response.list.JobOrderFileAttachmentListWrapper;
import com.bullhornsdk.data.model.response.list.JobOrderListWrapper;
import com.bullhornsdk.data.model.response.list.JobSubmissionCertificationRequirementListWrapper;
...
import com.bullhornsdk.data.model.response.list.LocationListWrapper;
...
import com.bullhornsdk.data.model.response.list.OpportunityFileAttachmentListWrapper;
import com.bullhornsdk.data.model.response.list.OpportunityListWrapper;
import com.bullhornsdk.data.model.response.list.PayMasterListWrapper;
import com.bullhornsdk.data.model.response.list.PayableChargeListWrapper;
...
import com.bullhornsdk.data.model.response.list.PlacementFileAttachmentListWrapper;
...
import com.bullhornsdk.data.model.response.list.SurchargeListWrapper;
import com.bullhornsdk.data.model.response.list.TaskListWrapper;
import com.bullhornsdk.data.model.response.list.TaxListWrapper;
...
import com.bullhornsdk.data.model.response.list.UserHousingComplexUnitListWrapper;
...
import com.bullhornsdk.data.model.response.single.BatchGroupWrapper;
import com.bullhornsdk.data.model.response.single.BillMasterTransactionWrapper;
import com.bullhornsdk.data.model.response.single.BillMasterWrapper;
import com.bullhornsdk.data.model.response.single.BillableChargeFileAttachmentWrapper;
import com.bullhornsdk.data.model.response.single.BillableChargeWrapper;
import com.bullhornsdk.data.model.response.single.BillingProfileWrapper;
import com.bullhornsdk.data.model.response.single.BillingSyncBatchWrapper;
...
import com.bullhornsdk.data.model.response.single.CandidateCertificationRequirementWrapper;
...
import com.bullhornsdk.data.model.response.single.CandidateFileAttachmentWrapper;
...
import com.bullhornsdk.data.model.response.single.CanvasReportWrapper;
import com.bullhornsdk.data.model.response.single.CategoryWrapper;
import com.bullhornsdk.data.model.response.single.CertificationFileAttachmentWrapper;
import com.bullhornsdk.data.model.response.single.CertificationGroupWrapper;
import com.bullhornsdk.data.model.response.single.CertificationRequirementStatusLookupWrapper;
import com.bullhornsdk.data.model.response.single.CertificationRequirementWrapper;
import com.bullhornsdk.data.model.response.single.CertificationWrapper;
import com.bullhornsdk.data.model.response.single.ClientContact1Wrapper;
import com.bullhornsdk.data.model.response.single.ClientContact2Wrapper;
import com.bullhornsdk.data.model.response.single.ClientContact3Wrapper;
import com.bullhornsdk.data.model.response.single.ClientContact4Wrapper;
import com.bullhornsdk.data.model.response.single.ClientContact5Wrapper;
import com.bullhornsdk.data.model.response.single.ClientContactFileAttachmentWrapper;
import com.bullhornsdk.data.model.response.single.ClientContactWrapper;
import com.bullhornsdk.data.model.response.single.ClientCorporation1Wrapper;
import com.bullhornsdk.data.model.response.single.ClientCorporation2Wrapper;
import com.bullhornsdk.data.model.response.single.ClientCorporation3Wrapper;
import com.bullhornsdk.data.model.response.single.ClientCorporation4Wrapper;
import com.bullhornsdk.data.model.response.single.ClientCorporation5Wrapper;
import com.bullhornsdk.data.model.response.single.ClientCorporationCertificationWrapper;
import com.bullhornsdk.data.model.response.single.ClientCorporationFileAttachmentWrapper;
...
import com.bullhornsdk.data.model.response.single.CurrencyUnityWrapper;
import com.bullhornsdk.data.model.response.single.DepartmentWrapper;
import com.bullhornsdk.data.model.response.single.DiscountWrapper;
import com.bullhornsdk.data.model.response.single.DistributionListWrapper;
import com.bullhornsdk.data.model.response.single.EarnCodeWrapper;
import com.bullhornsdk.data.model.response.single.FileEntityWrapper;
import com.bullhornsdk.data.model.response.single.GeneralLedgerAccountWrapper;
import com.bullhornsdk.data.model.response.single.GeneralLedgerSegment1Wrapper;
import com.bullhornsdk.data.model.response.single.GeneralLedgerSegment2Wrapper;
import com.bullhornsdk.data.model.response.single.GeneralLedgerSegment3Wrapper;
import com.bullhornsdk.data.model.response.single.GeneralLedgerSegment4Wrapper;
import com.bullhornsdk.data.model.response.single.GeneralLedgerSegment5Wrapper;
import com.bullhornsdk.data.model.response.single.GeneralLedgerSegmentTypeWrapper;
import com.bullhornsdk.data.model.response.single.GeneralLedgerSegmentWrapper;
import com.bullhornsdk.data.model.response.single.GeneralLedgerServiceCodeWrapper;
import com.bullhornsdk.data.model.response.single.HousingComplexFurnitureDeliveryWrapper;
import com.bullhornsdk.data.model.response.single.HousingComplexUnitWrapper;
import com.bullhornsdk.data.model.response.single.HousingComplexUtilityAccountWrapper;
import com.bullhornsdk.data.model.response.single.HousingComplexWrapper;
import com.bullhornsdk.data.model.response.single.InvoiceStatementBatchWrapper;
import com.bullhornsdk.data.model.response.single.InvoiceStatementDiscountWrapper;
import com.bullhornsdk.data.model.response.single.InvoiceStatementExportBatchWrapper;
import com.bullhornsdk.data.model.response.single.InvoiceStatementExportWrapper;
import com.bullhornsdk.data.model.response.single.InvoiceStatementLineItemWrapper;
import com.bullhornsdk.data.model.response.single.InvoiceStatementMessageTemplateWrapper;
import com.bullhornsdk.data.model.response.single.InvoiceStatementSurchargeWrapper;
import com.bullhornsdk.data.model.response.single.InvoiceStatementTaxWrapper;
import com.bullhornsdk.data.model.response.single.InvoiceStatementTemplateWrapper;
import com.bullhornsdk.data.model.response.single.InvoiceStatementWrapper;
import com.bullhornsdk.data.model.response.single.InvoiceTermWrapper;
import com.bullhornsdk.data.model.response.single.JobBoardPostWrapper;
import com.bullhornsdk.data.model.response.single.JobOrderFileAttachmentWrapper;
import com.bullhornsdk.data.model.response.single.JobOrderWrapper;
import com.bullhornsdk.data.model.response.single.JobSubmissionCertificationRequirementWrapper;
...
import com.bullhornsdk.data.model.response.single.LocationWrapper;
...
import com.bullhornsdk.data.model.response.single.OpportunityFileAttachmentWrapper;
import com.bullhornsdk.data.model.response.single.OpportunityWrapper;
import com.bullhornsdk.data.model.response.single.PayMasterWrapper;
import com.bullhornsdk.data.model.response.single.PayableChargeWrapper;
...
import com.bullhornsdk.data.model.response.single.PlacementFileAttachmentWrapper;
...
import com.bullhornsdk.data.model.response.single.SurchargeWrapper;
import com.bullhornsdk.data.model.response.single.TaskWrapper;
import com.bullhornsdk.data.model.response.single.TaxWrapper;
...
import com.bullhornsdk.data.model.response.single.UserHousingComplexUnitWrapper;
