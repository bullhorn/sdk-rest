...
public enum BullhornEntityInfo {
    ...
    CLIENT_CORPORATION_APPOINTMENT("ClientCorporationAppointment", ClientCorporationAppointment.class,
        ClientCorporationAppointmentWrapper.class, ClientCorporationAppointmentListWrapper.class, null, null),
