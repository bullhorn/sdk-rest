...
public enum BullhornEntityInfo {
    ...
    PLACEMENT_BILL_RULESET("PlacementBillRuleset", PlacementBillRuleset.class, PlacementBillRulesetWrapper.class, PlacementBillRulesetListWrapper.class, "PlacementBillRulesetEditHistory", "PlacementBillRulesetEditHistoryFieldChange"),
    PLACEMENT_BILL_RULESET_VERSION("PlacementBillRulesetVersion", PlacementBillRulesetVersion.class, PlacementBillRulesetVersionWrapper.class, PlacementBillRulesetVersionListWrapper.class, null, null),
    PLACEMENT_PAY_RULESET("PlacementPayRuleset", PlacementPayRuleset.class, PlacementPayRulesetWrapper.class, PlacementPayRulesetListWrapper.class, "PlacementPayRulesetEditHistory", "PlacementPayRulesetEditHistoryFieldChange"),
    PLACEMENT_PAY_RULESET_VERSION("PlacementPayRulesetVersion", PlacementPayRulesetVersion.class, PlacementPayRulesetVersionWrapper.class, PlacementPayRulesetVersionListWrapper.class, null, null),
