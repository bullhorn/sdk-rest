...
@JsonPropertyOrder({"id", "baseAmount", "billMasterTransactionDiscountDetail", "calculateAndDisplayOnInvoice", "discountAmount", "discountRate",
    "ignoreForSalesTaxCalculations", "invoiceStatement", "rate", "sentToAccountsReceivable", "title"
})
public class InvoiceStatementDiscountRate extends AbstractEntity implements QueryEntity, UpdateEntity, CreateEntity, EditHistoryEntity {
    ...
    public boolean equals(Object o) {
        ...
        InvoiceStatementDiscountRate that = (InvoiceStatementDiscountRate) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, baseAmount, billMasterTransactionDiscountDetail, calculateAndDisplayOnInvoice, discountAmount, discountRate, ignoreForSalesTaxCalculations, invoiceStatement, rate, sentToAccountsReceivable, title);
    }

    @Override
    public String toString() {
        return "InvoiceStatementDiscountRate{" +
            "id=" + id +
