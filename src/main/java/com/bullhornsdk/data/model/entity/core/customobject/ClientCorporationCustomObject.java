...
public class ClientCorporationCustomObject extends CustomObjectBase implements QueryEntity {

    private Integer id;

    public ClientCorporationCustomObject() {
        super();
    }

    public ClientCorporationCustomObject(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object o) {
        ...
        ClientCorporationCustomObject that = (ClientCorporationCustomObject) o;
