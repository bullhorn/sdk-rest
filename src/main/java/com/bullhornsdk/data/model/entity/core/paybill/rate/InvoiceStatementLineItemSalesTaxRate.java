...
@JsonPropertyOrder({"id", "allSalesTaxRate", "baseAmount", "billMasterTransactionSalesTaxDetail", "dateAdded", "externalSalesTaxRate",
    "invoiceStatementLineItem", "jurisdictionName", "jurisdictionType", "rate", "salesTaxRate", "taxAmount"
})
public class InvoiceStatementLineItemSalesTaxRate extends AbstractEntity implements QueryEntity, UpdateEntity, CreateEntity, EditHistoryEntity {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(allSalesTaxRate, that.allSalesTaxRate) && Objects.equals(baseAmount, that.baseAmount) && Objects.equals(billMasterTransactionSalesTaxDetail, that.billMasterTransactionSalesTaxDetail) && Objects.equals(dateAdded, that.dateAdded) && Objects.equals(externalSalesTaxRate, that.externalSalesTaxRate) && Objects.equals(invoiceStatementLineItem, that.invoiceStatementLineItem) && Objects.equals(jurisdictionName, that.jurisdictionName) && Objects.equals(jurisdictionType, that.jurisdictionType) && Objects.equals(rate, that.rate) && Objects.equals(salesTaxRate, that.salesTaxRate) && Objects.equals(taxAmount, that.taxAmount);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, allSalesTaxRate, baseAmount, billMasterTransactionSalesTaxDetail, dateAdded, externalSalesTaxRate, invoiceStatementLineItem, jurisdictionName, jurisdictionType, rate, salesTaxRate, taxAmount);
    }
