...
@JsonPropertyOrder({"id", "amount", "dateAdded", "dateLastModified", "effectiveDate", "effectiveEndDate", "generalLedgerAccount",
    ...
    "isDeleted", "jurisdictionName", "jurisdictionType", "label", "owner", "rate", "reportingCodeName", "source", "stateID", "status", "taxType",
    "type", "versionID", "versions"
})
public class SalesTaxRate extends AbstractEntity implements QueryEntity, UpdateEntity, CreateEntity, EditHistoryEntity, DateLastModifiedEntity,
    ...
    @JsonProperty("versions")
    public void setVersions(OneToMany<SalesTaxRateVersion> versions) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(amount, that.amount) && Objects.equals(dateAdded, that.dateAdded) && Objects.equals(dateLastModified, that.dateLastModified) && Objects.equals(effectiveDate, that.effectiveDate) && Objects.equals(effectiveEndDate, that.effectiveEndDate) && Objects.equals(generalLedgerAccount, that.generalLedgerAccount) && Objects.equals(generalLedgerSegment1, that.generalLedgerSegment1) && Objects.equals(generalLedgerSegment2, that.generalLedgerSegment2) && Objects.equals(generalLedgerSegment3, that.generalLedgerSegment3) && Objects.equals(generalLedgerSegment4, that.generalLedgerSegment4) && Objects.equals(generalLedgerSegment5, that.generalLedgerSegment5) && Objects.equals(generalLedgerServiceCode, that.generalLedgerServiceCode) && Objects.equals(isDeleted, that.isDeleted) && Objects.equals(jurisdictionName, that.jurisdictionName) && Objects.equals(jurisdictionType, that.jurisdictionType) && Objects.equals(label, that.label) && Objects.equals(owner, that.owner) && Objects.equals(rate, that.rate) && Objects.equals(reportingCodeName, that.reportingCodeName) && Objects.equals(source, that.source) && Objects.equals(stateID, that.stateID) && Objects.equals(status, that.status) && Objects.equals(taxType, that.taxType) && Objects.equals(type, that.type) && Objects.equals(versionID, that.versionID) && Objects.equals(versions, that.versions);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, amount, dateAdded, dateLastModified, effectiveDate, effectiveEndDate, generalLedgerAccount, generalLedgerSegment1, generalLedgerSegment2, generalLedgerSegment3, generalLedgerSegment4, generalLedgerSegment5, generalLedgerServiceCode, isDeleted, jurisdictionName, jurisdictionType, label, owner, rate, reportingCodeName, source, stateID, status, taxType, type, versionID, versions);
    }
