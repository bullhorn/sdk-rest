...
public abstract class CustomObjectInstance extends AbstractEntity implements UpdateEntity, CreateEntity, SearchEntity, QueryEntity, AssociationEntity, HardDeleteEntity {
    ...
    public String toString() {
        return new ToStringBuilder(this)
                ...
                .append("text8", text8)
                .append("text9", text9)
                .append("text10", text10)
                .append("text11", text11)
                .append("text12", text12)
                .append("text13", text13)
                .append("text14", text14)
                .append("text15", text15)
                .append("text16", text16)
                .append("text17", text17)
                .append("text18", text18)
                .append("text19", text19)
                .append("text20", text20)
                .append("int1", int1)
                .append("int2", int2)
                .append("int3", int3)
                .append("int4", int4)
                ...
                .append("int9", int9)
                .append("int10", int10)
                .append("float1", float1)
                .append("float2", float2)
                .append("float3", float3)
                .append("float4", float4)
                .append("float5", float5)
                .append("float6", float6)
                .append("float7", float7)
                .append("float8", float8)
                .append("float9", float9)
                .append("float10", float10)
                .append("textBlock1", textBlock1)
                .append("textBlock2", textBlock2)
                .append("textBlock3", textBlock3)
                .append("textBlock4", textBlock4)
                .append("textBlock5", textBlock5)
                .append("date1", date1)
                .append("date2", date2)
                .append("date3", date3)
                .append("date4", date4)
