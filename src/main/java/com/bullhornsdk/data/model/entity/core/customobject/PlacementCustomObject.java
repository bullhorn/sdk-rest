...
public class PlacementCustomObject extends CustomObjectBase implements QueryEntity {

    private Integer id;

    private String entityList;

    public PlacementCustomObject() {
        super();
    }

    public PlacementCustomObject(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object o) {
        ...
        PlacementCustomObject that = (PlacementCustomObject) o;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (entityList != null ? entityList.hashCode() : 0);
