...
public class StandardRestEntityValidator implements RestEntityValidator {
	...
	public StandardRestEntityValidator(LocalValidatorFactoryBean validator, RestAppointmentValidator restAppointmentValidator,
			...
			RestPlacementValidator restPlacementValidator, RestPlacementCommissionValidator restPlacementCommissionValidator,
			RestSendoutValidator restSendoutValidator, RestTaskValidator restTaskValidator) {
		super();
